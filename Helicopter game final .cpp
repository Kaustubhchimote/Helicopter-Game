...
setcolor(BLACK);
setfillstyle(SOLID_FILL,BLACK);
fillellipse(left,top-rady,radx+11,rady-5);
fillellipse(left-62,top-9,10,4);
fillellipse(left,top,radx,rady);
bar(left,top-3,left-65,top+3);
sector(left,top,90,270,radx,rady);
bar(left-65,top-3,left-62,top-8);
...
switch(selected)
{
 ...
 case 3 : cleardevice();
	  ...
	  outtextxy(80,getmaxy()/2,"Kaustubh");

	  outtextxy(300,getmaxy()/2+40,"");
	  outtextxy(350,getmaxy()/2+70,"Chimote");
	  settextstyle(2,0,5);
	  setcolor(RED);
	  outtextxy(362,390,"Press any key to continue.....");
